                                ...
                                <div className="option-item">
                                    {
                                        telegramcode2 ?
                                            <>
                                                ...
                                                <div className={`pop_up ${statusi == true ? 'd-block' : 'd-none'}`}>
